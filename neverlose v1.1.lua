...
local function ConnectButtonEffect(UIFrame:Frame&TextButton&ImageLabel,UIStroke:UIStroke,int)
        ...
        local h,s,v = OldColor:ToHSV()
        local MainColor = Color3.fromHSV(h, s, math.clamp(v + int, 0, 1))
...
function NEVERLOSE:AddWindow(NameScriptHub,Text,UICustomSize)
        ...
        function WindowFunctinos:AddTab(TabNameString,IconType)
                ...
                function TabFunctions:AddSection(SectionName,parentname)
                        ...
                        -- NEW COMPONENTS ADDED BY USER REQUEST
                        -- Note: AddButton and AddDropdown already exist in original NEVERLOSE, only adding truly new components

                        -- Add TextBox Component
                        function sectionfunc:AddTextBox(TextBoxName, PlaceholderText, callback)
                                ...
                                TextBoxFrame.Size = UDim2.new(0.899999976, 0, 0.5, 0)
                                TextBoxFrame.ZIndex = 5

                                UIAspectRatioConstraint.Parent = TextBoxFrame
                                UIAspectRatioConstraint.AspectRatio = 7.000
                                UIAspectRatioConstraint.AspectType = Enum.AspectType.ScaleWithParentSize
                                ...
                                LabelText.AnchorPoint = Vector2.new(0.5, 0.5)
                                LabelText.BackgroundTransparency = 1.000
                                LabelText.Position = UDim2.new(0.25, 0, 0.5, 0)
                                LabelText.Size = UDim2.new(0.48, 0, 0.7, 0)
                                LabelText.ZIndex = 6
                                LabelText.Font = Enum.Font.SourceSansSemibold
                                LabelText.Text = TextBoxName or "TextBox"
                                LabelText.TextColor3 = Color3.fromRGB(255, 255, 255)
                                LabelText.TextScaled = true
                                ...
                                InputFrame.BackgroundColor3 = NEVERLOSE.Themes.ButtonBlackgroundColor
                                InputFrame.BackgroundTransparency = 0.2
                                InputFrame.Position = UDim2.new(0.98, 0, 0.5, 0)
                                InputFrame.Size = UDim2.new(0.45, 0, 0.6, 0)
                                InputFrame.ZIndex = 6
                                ...
                                ConnectButtonEffect(InputFrame, UIStroke, 0.2)
                                update_section_size()

                                local textbox_func = {}
                                function textbox_func:Text(text)
                                        LabelText.Text = tostring(text)
                                end

                                function textbox_func:SetValue(value)
                                        TextBox.Text = tostring(value)
                                end

                                function textbox_func:GetValue()
                                        return TextBox.Text
                                end
                        ...
                        function sectionfunc:AddColorPicker(ColorPickerName, DefaultColor, callback)
                                ...
                                ColorPickerFrame.Size = UDim2.new(0.899999976, 0, 0.5, 0)
                                ...
                                ColorButton.BackgroundColor3 = NEVERLOSE.Themes.ButtonBlackgroundColor
                                ColorButton.BackgroundTransparency = 0.2
                                ColorButton.Position = UDim2.new(0.98, 0, 0.5, 0)
                                ColorButton.Size = UDim2.new(0.15, 0, 0.6, 0)
                                ...
                                ColorDisplay.Size = UDim2.new(0.8, 0, 0.8, 0)
                                ...
                                ColorPickerPopup.AnchorPoint = Vector2.new(1, 0)
                                ColorPickerPopup.BackgroundColor3 = NEVERLOSE.Themes.SectionColor
                                ColorPickerPopup.Position = UDim2.new(0.98, 0, 1.1, 0)
                                ColorPickerPopup.Size = UDim2.new(0.6, 0, 0, 0)
                                ...
                                UIStroke_2.Color = NEVERLOSE.Themes.StrokeColor
                                UIStroke_2.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                                UIStroke_2.Parent = ColorPickerPopup

                                -- Simple RGB sliders (simplified version)
                                local RSlider = Instance.new("TextLabel")
                                RSlider.Parent = ColorPickerPopup
                                RSlider.BackgroundTransparency = 1
                                RSlider.Position = UDim2.new(0, 10, 0, 10)
                                RSlider.Size = UDim2.new(1, -20, 0, 20)
                                RSlider.ZIndex = 11
                                RSlider.Font = Enum.Font.SourceSansBold
                                ...
                                GSlider.Parent = ColorPickerPopup
                                GSlider.BackgroundTransparency = 1
                                GSlider.Position = UDim2.new(0, 10, 0, 35)
                                GSlider.Size = UDim2.new(1, -20, 0, 20)
                                GSlider.ZIndex = 11
                                GSlider.Font = Enum.Font.SourceSansBold
                                ...
                                BSlider.Parent = ColorPickerPopup
                                BSlider.BackgroundTransparency = 1
                                BSlider.Position = UDim2.new(0, 10, 0, 60)
                                BSlider.Size = UDim2.new(1, -20, 0, 20)
                                BSlider.ZIndex = 11
                                BSlider.Font = Enum.Font.SourceSansBold
                                ...
                                CloseButton.BackgroundColor3 = NEVERLOSE.Themes.MainColor
                                CloseButton.Position = UDim2.new(1, -5, 0, 90)
                                ...
                                local function toggleColorPicker()
                                        ...
                                        local targetSize = isOpen and UDim2.new(0.6, 0, 0, 120) or UDim2.new(0.6, 0, 0, 0)
                                        TweenService:Create(ColorPickerPopup, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Size = targetSize}):Play()
                                end

                                cretate_button(ColorButton).MouseButton1Click:Connect(toggleColorPicker)
                                ConnectButtonEffect(ColorButton, UIStroke, 0.2)

                                CloseButton.MouseButton1Click:Connect(function()
                                        isOpen = false
                                        ColorPickerPopup.Visible = false
                                        TweenService:Create(ColorPickerPopup, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Size = UDim2.new(0.6, 0, 0, 0)}):Play()
                                        callback(currentColor)
                                end)

                                update_section_size()

                                local colorpicker_func = {}
                                function colorpicker_func:Text(text)
                                        LabelText.Text = tostring(text)
                                end

                                function colorpicker_func:SetValue(color)
                                        currentColor = color
                                        ColorDisplay.BackgroundColor3 = color
                                        -- Update displays
                                        RSlider.Text = "R: " .. math.floor(color.R * 255)
                                        GSlider.Text = "G: " .. math.floor(color.G * 255)
                                        BSlider.Text = "B: " .. math.floor(color.B * 255)
                                end

                                return colorpicker_func
                        end

                        -- Add Theme Color Picker for UI customization with live updates
                        function sectionfunc:AddThemeColorPicker(ColorName, ThemeProperty, DefaultColor)
                                DefaultColor = DefaultColor or NEVERLOSE.Themes[ThemeProperty] or Color3.fromRGB(255, 255, 255)

                                local colorPicker = sectionfunc:AddColorPicker("Theme: " .. ColorName, DefaultColor, function(newColor)
                                        NEVERLOSE.Themes[ThemeProperty] = newColor
                                        
                                        -- Trigger live theme updates to all existing UI elements
                                        for i, updateFunction in ipairs(NEVERLOSE.auto_function) do
                                                pcall(function()
                                                        updateFunction()
                                                end)
                                        end
                                        ...
                                        if notification then
                                                notification:Notify("success", "Theme Updated", "UI colors refreshed!", 2)
                                        end
                                end)
